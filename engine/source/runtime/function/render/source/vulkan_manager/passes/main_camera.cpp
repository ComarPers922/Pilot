...
namespace Pilot
{
    ...
    void PMainCameraPass::setupRenderPass()
    {
        ...
        VkSubpassDependency& blur_pass_depend_on_tone_mapping_pass = dependencies[6];
        blur_pass_depend_on_tone_mapping_pass.srcSubpass = _main_camera_subpass_blur;
        blur_pass_depend_on_tone_mapping_pass.dstSubpass = _main_camera_subpass_ui;
        blur_pass_depend_on_tone_mapping_pass.srcStageMask = VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT;
        blur_pass_depend_on_tone_mapping_pass.dstStageMask = VK_PIPELINE_STAGE_FRAGMENT_SHADER_BIT;
        blur_pass_depend_on_tone_mapping_pass.srcAccessMask = VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT;
        blur_pass_depend_on_tone_mapping_pass.dstAccessMask = VK_ACCESS_SHADER_READ_BIT;
        blur_pass_depend_on_tone_mapping_pass.dependencyFlags = VK_DEPENDENCY_BY_REGION_BIT;
